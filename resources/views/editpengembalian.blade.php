...
<div class="konten">
  <form action="/pengembalian/update/{{$pengembalian->id}}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
<div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="kode" type="text" class="form-control" name="kode" value="{{ $pengembalian->kode }}" required readonly="">
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('buku') ? ' has-error' : '' }}">
                            <label for="buku" class="col-md-4 control-label">Buku</label>
                            <div class="col-md-6">
                                <input id="buku" type="text" class="form-control" name="buku" value="{{ $pengembalian->buku }}" required>
                                @if ($errors->has('buku'))
                        ...
                        <div class="form-group{{ $errors->has('peminjam') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="peminjam" type="text" class="form-control" name="peminjam" value="{{ $pengembalian->peminjam }}" required>
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="">
                                <option value=""></option>
                                <option value="TI" {{$pengembalian->prodi === "TI" ? "selected" : ""}} >Teknik Informatika</option>
                                <option value="SI" {{$pengembalian->prodi === "SI" ? "selected" : ""}} >Sistem Informasi</option>
                                <option value="MI" {{$pengembalian->prodi === "MI" ? "selected" : ""}} >Manajemen Informatika</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tgl_pinjam" type="date" class="form-control" name="tgl_pinjam" value="{{ $pengembalian->tgl_pinjam }}" required>
                        ...
                        <div class="form-group{{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tgl_kembali" type="date" class="form-control" name="tgl_kembali" value="{{ $pengembalian->tgl_kembali }}" required>
                        ...
                        <div class="form-group{{ $errors->has('denda') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="denda" type="text" class="form-control" name="denda" value="{{ $pengembalian->denda }}" required>
                                @if ($errors->has('denda'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <select class="form-control" name="status" value="{{ $pengembalian->status }}"required="">
                                <option value=""></option>
